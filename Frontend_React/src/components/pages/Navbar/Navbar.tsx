...
import { Menu, X, BarChart3, FileText, Target, Search,Sparkles, Settings, SparkleIcon, WandSparkles, LucideSparkles, SparklesIcon, WandSparklesIcon } from "lucide-react";
...
const navLinks = [
  ...
  { name: "AI Jobs", path: "/ai-jobs", icon: WandSparklesIcon },
...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-gradient-to-r from-secondary/50 via-primary/40 to-secondary/50 backdrop-blur-md shadow-sm border-b border-glass-border z-50 transition-all duration-300 bg-white dark:bg-black">
      ...
      <div className="flex justify-between items-center h-16">
        ...
        <div className="md:hidden">
          ...
          <SheetContent side="right" className="w-100 bg-white border-nav-border bg-gradient-to-r from-secondary/70 via-secondary/40 to-primary/30 backdrop-blur-md shadow-sm border-b border-glass-border">
